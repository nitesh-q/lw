  ...
  WIDGETS: [
    {
      ...
      menuItems: [
        ...
        { id: 5, url: "/atoreCredit", text: "Store Credit" },
        { id: 6, url: "/automation", text: "Automation" },
        { id: 7, url: "/b2bGiftcards", text: "B2B Gift Cards" },
        // { id: 8, url: "#", text: "Geolocation" },
        // { id: 9, url: "#", text: "Promotion Engine" },
      ],
    },
    {
      id: 2,
      title: "Industries",
      menuItems: [
        { id: 1, url: "#", text: "Finance" },
        { id: 2, url: "#", text: "Public Sector" },
        { id: 3, url: "#", text: "Smart Office" },
        { id: 4, url: "#", text: "Retail" },
      ],
    },
    {
      id: 3,
